...
export default function EmailClub() {
  ...
  return (
    <section id="contact" className="bg-paper border-t border-stone scroll-mt-24">
          ...
          {status === "success" && discountCode && (
            ...
            >
              ...
              <span
                ...
                style={{ fontFamily: "var(--font-heading)", fontSize: "18px", letterSpacing: "0.15em" }}
              >
                {discountCode}
              </span>
              <p
                className="text-ash mt-2"
                style={{ fontFamily: "var(--font-body)", fontSize: "10px", letterSpacing: "0.1em" }}
              >
