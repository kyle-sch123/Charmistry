 ...
 *
 * The inline snippet is the client-supplied base pixel, parameterised by env.
 * It self-injects fbevents.js and fires the initial PageView, so the route
 * effect below skips its first (mount) run to avoid double-counting page one.
 */
